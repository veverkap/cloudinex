defmodule Cloudinex.UrlTest do
  ...
  setup do
    ...
    Application.put_env(:cloudinex, :base_image_url, "//res.cloudinary.com/")

    Application.put_env(:cloudinex, :secret, "secret")
  ...
  describe "tests" do
    ...
    test "handles multiple options" do
      expected =
        "//res.cloudinary.com/demo/image/upload/s--cvhISy3m--/c_fill,f_auto,fl_progressive,h_254,q_jpegmini,w_300/public_id"
    ...
    test "handles version" do
      ...
      assert expected == Cloudinex.Url.for("a_public_id", %{version: 1_471_959_066})
    end
    ...
    test "handles options as a list" do
      expected =
        "//res.cloudinary.com/demo/image/upload/bo_5px_solid_rgb:c22c33,c_fill,h_246,q_80,r_5,w_470/c_scale,g_south_east,l_my_overlay,w_128,x_5,y_15/a_public_id"

      result =
        Cloudinex.Url.for("a_public_id", [
          %{
            border: "5px_solid_rgb:c22c33",
            radius: 5,
            crop: "fill",
            height: 246,
            width: 470,
